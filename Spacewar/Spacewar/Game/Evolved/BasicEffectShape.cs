...
namespace Spacewar
{
    ...
    class BasicEffectShape : Shape
    {
        ...
        private static Color cockpit1 = new Color((.529f * 255), 255, 255, 0);
        private static Color cockpit2 = new Color(255, 255, (.373f * 255), 0);
        private static Color engines = new Color((.925f * 255), (.529f * 255), 255, 0);
